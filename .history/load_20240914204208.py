...
def compare_model_shapes(file1, file2):
    ...
    if unique_to_file1:
        ...
        for key in unique_to_file1:
            print(f"  {key} {weights1[key].shape}")
    else:
...
file1 = '/mnt/disk_1/tengbo/peract_bimanual/log/debug/ANY_BIMANUAL/seed0/weights/20/QAttentionAgent_layer0.pt'
file2 = '/mnt/disk_1/tengbo/peract_bimanual/log/debug/ANY_BIMANUAL/seed0/weights/0/QAttentionAgent_layer0.pt'
