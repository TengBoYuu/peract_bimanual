...
data2 = [8.00, 32.00, 24.00, 20.00, 12.00, 16.00, 8.00, 84.00, 8.00, 4.00, 4.00, 28.00]
...
# 在柱子上方标注平均值，避免被error bar挡住
for bar, mean in zip(bars, means):
    height = bar.get_height()
    ax.annotate(f'{mean:.2f}', xy=(bar.get_x() + bar.get_width() / 2, height + 1),  # 位置在error bar上方
                xytext=(0, 3),  # 位置偏移
