...
# 读取两个txt文件中的数据
voxel_left = read_voxel_data_from_txt("/mnt/disk_1/tengbo/peract_bimanual/L_voxel_result.txt").reshape(100, 100, 100, 10)
voxel_right = read_voxel_data_from_txt("/mnt/disk_1/tengbo/peract_bimanual/L_voxel_result1.txt").reshape(100, 100, 100, 10)
