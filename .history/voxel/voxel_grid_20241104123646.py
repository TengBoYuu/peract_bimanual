...
class VoxelGrid(nn.Module):
    ...
    def coords_to_bounding_voxel_grid(
        ...
        # print(voxel_values_pruned_flat.shape)
        # print(self._voxel_feature_size)
...
if __name__ == "__main__":
    ...
    coords = torch.rand(1, 100, 3).to(device)
    coord_features = torch.rand(1, 100, 3).to(device)
    voxel_grid(coords, coord_features)
    print("Voxel grid test passed")
