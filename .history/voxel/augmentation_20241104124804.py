...
if __name__ == "__main__":
    ...
    # Sample inputs
    batch_size = 1
    pcd = [torch.rand(batch_size, 1000, 3) for _ in range(1)]  # Random point clouds
    ...
    bounds = torch.tensor([[0.0, 0.0, -0.2, 1.0, 0.0, 0.8]])
    layer = 0
    ...
    # Display results
    print("Right Action Trans:", right_action_trans_out)
    print("Right Action Rot Grip:", right_action_rot_grip_out)
    print("Left Action Trans:", left_action_trans_out)
    print("Left Action Rot Grip:", left_action_rot_grip_out)
    print("PCD Output Shape:", [p.shape for p in pcd_out])
