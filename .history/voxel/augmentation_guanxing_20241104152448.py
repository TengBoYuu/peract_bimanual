...
if __name__ == "__main__":
    ...
    right_action_rot_grip_out = utils.discrete_euler_to_quaternion(right_action_rot_grip_out, rot_resolution)
    right_action_gripper_pose = np.concatenate([right_action_trans_out.cpu().numpy(), right_action_rot_grip_out.cpu().numpy()], axis=1)
    ...
    left_action_rot_grip_out = utils.discrete_euler_to_quaternion(left_action_rot_grip_out, rot_resolution)
    left_action_gripper_pose = np.concatenate([left_action_trans_out, left_action_rot_grip_out], axis=1)
