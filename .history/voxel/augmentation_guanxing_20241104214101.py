...
def my_bimanual_apply_se3_augmentation(
    ...
    while torch.any(right_perturbed_trans < 0) or torch.any(left_perturbed_trans < 0):
        ...
        left_perturbed_action_gripper_4x4[:, 0:3, 3] = left_perturbed_action_gripper_4x4[:, 0:3, 3] - center_action
        left_perturbed_action_gripper_4x4[:, 0:3, 3] = torch.bmm(
            left_perturbed_action_gripper_4x4[:, 0:3, 3].unsqueeze(-1), rot_shift_3x3
        ).squeeze(-1)
        left_perturbed_action_gripper_4x4[:, 0:3, 3] += trans_shift
