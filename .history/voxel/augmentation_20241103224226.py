...
# Step 1: 先对右臂使用 rot_shift_4x4 进行旋转
right_perturbed_action_gripper_4x4 = torch.bmm(right_action_gripper_4x4, rot_shift_4x4)
right_perturbed_action_gripper_4x4[:, 0:3, 3] += trans_shift

# Step 2: 使用 average_action_gripper_4x4 再次旋转
# 注意：只进行旋转操作，不再应用平移
final_right_perturbed_action_gripper_4x4 = torch.bmm(
    right_perturbed_action_gripper_4x4, average_action_gripper_4x4
)
