...
def apply_transformation_to_action(
    ...
    """
    对 right_action_trans, left_action_trans, right_action_rot_grip, left_action_rot_grip 应用与 pcd 一致的平移和旋转变换

    :param right_action_trans: 右臂的平移 [bs, 3]
    :param left_action_trans: 左臂的平移 [bs, 3]
    :param right_action_rot_grip: 右臂的旋转和抓取状态 [bs, 4] (前三个维度为旋转信息)
    :param left_action_rot_grip: 左臂的旋转和抓取状态 [bs, 4] (前三个维度为旋转信息)
    :param center_4x4: 两臂的中心点，用于作为旋转和位移的基准点 [bs, 4, 4]
    :param trans_shift_4x4: 平移变换矩阵 [bs, 4, 4]
    :param rot_shift_4x4: 旋转变换矩阵 [bs, 4, 4]
    :return: 更新后的 right_action_trans, left_action_trans, right_action_rot_grip, left_action_rot_grip
    """

    # 旋转 right_action_rot_grip 和 left_action_rot_grip 的前三个分量（旋转部分）
    ...
    # 平移 right_action_trans 和 left_action_trans
