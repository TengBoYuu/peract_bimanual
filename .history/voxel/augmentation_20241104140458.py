...
if __name__ == "__main__":
    ...
    left_action_gripper_pose = left_action_gripper_pose.numpy()

    # Visualize and save before and after augmentation
    plot_point_cloud(before_np, left_action_gripper_pose, right_action_gripper_pose, "Before Augmentation", "debug/before.png")
    plot_point_cloud(after_np, left_action_gripper_pose, right_action_gripper_pose, "After Augmentation", "debug/after.png")
