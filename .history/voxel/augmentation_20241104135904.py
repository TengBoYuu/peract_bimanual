...
if __name__ == "__main__":
    ...
    plot_point_cloud(before_np, left_action_gripper_pose, right_action_gripper_pose, "Before Augmentation", "before.png")
    plot_point_cloud(after_np, left_action_gripper_pose, right_action_gripper_pose, "After Augmentation", "after.png")
