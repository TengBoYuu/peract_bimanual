...
if __name__ == "__main__":
    ...
    right_attention_coordinate = bounds[:, :3] + res * right_action_trans_out + res / 2
    right_action_rot_grip_out = utils.discrete_euler_to_quaternion(right_action_rot_grip_out, rot_resolution)
    right_action_gripper_pose = np.concatenate([right_attention_coordinate.cpu().numpy(), right_action_rot_grip_out.cpu().numpy()], axis=1)
