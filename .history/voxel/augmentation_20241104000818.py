...
def apply_transformation_to_action(
    ...
    trans_shift_4x4 = trans_shift_4x4.float()
    right_action_trans = right_action_trans.float()
    left_action_trans = left_action_trans.float()
...
def bimanual_apply_se3_augmentation(
    ...
    print(right_action_rot_grip.shape)
    right_action_trans, right_action_rot_grip, left_action_trans, left_action_rot_grip = apply_transformation_to_action(
        right_action_trans,
        left_action_trans,
        right_action_rot_grip,
        left_action_rot_grip,
