...
if __name__ == "__main__":
    ...
    def plot_point_cloud(pcd, left_pose, right_pose, title, filename):
        ...
        ax.scatter(pcd[:, 0], pcd[:, 1], pcd[:, 2], c='b', marker='o', s=1, alpha=0.005)
        ax.scatter(left_pose[:, 0], left_pose[:, 1], left_pose[:, 2], c='r', marker='o', s=60)
        ax.scatter(right_pose[:, 0], right_pose[:, 1], right_pose[:, 2], c='r', marker='o', s=60)
