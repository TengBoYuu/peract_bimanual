...
# eval
    def act(self, step: int, observation: dict, deterministic=False, train_cfg = None) -> ActResult:
        deterministic = True
        ...
        print(inspect.getfile(train_cfg))
        print(train_cfg.framework.instructions)
        # inference
