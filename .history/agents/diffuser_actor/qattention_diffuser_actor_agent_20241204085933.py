...
import sys
from agents.peract_bimanual.skill_manager import OptionSelector
...
class QFunction(nn.Module):
    ...
    def forward(
        ...
        # print(instruction.shape) # [b,77 / 154,512]
        # forward pass
        if inference:
            out = self._qnet(
                gt_trajectory,
            ...
            if self.use_skill:
                ...
                instruction = torch.cat((selected_options, lang_token_embs),dim=1)
