...
from agents.bimanual_peract1.perceiver_lang_io import PerceiverVoxelLangEncoder
from agents.bimanual_peract1.qattention_peract_bc_agent import QAttentionPerActBCAgent
from agents.bimanual_peract1.qattention_stack_agent import QAttentionStackAgent

from omegaconf import DictConfig

# bimanual_peract 从这里创建机器人的，因为左右臂同时出，不需要单独创建，只需要用一个函数里面创建就好了
