    ...
    def forward(
        ...
        if self.use_skill:
            if self.lang_fusion_type == "seq":
                ...
                right_skill, left_skill = self.skill_manager(skill_ins_right, skill_ins_left,l) # 
                L_skill = (
                    l1_norm(left_skill) + l1_norm(right_skill) + 
                    0.01 * (l2_1_norm(left_skill) + l2_1_norm(right_skill))
                )
                print("L skill: ", L_skill)
                # right_skill = self.skill_manager(skill_ins_left,l)
                # left_skill = self.skill_manager(skill_ins_left,l)
