...
class OptionSelector(nn.Module):
    ...
    def forward(self, ins_right, ins_left, lang):
        ...
        ins_left = ins_right.view(ins_right.size(0),-1)
        ...
        skill_right = torch.matmul(probs_right, self.embeddings_matrix)
        skill_left = torch.matmul(probs_left, self.embeddings_matrix)
