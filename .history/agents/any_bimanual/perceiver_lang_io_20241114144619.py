...
class PerceiverVoxelLangEncoder(nn.Module):
    ...
    def forward(
        ...
        if self.use_prefix:
            ...
            print(encode_voxel_right.shape) 
...
if __name__ == "__main__":
    # Sample input
    voxel = np.random.rand(8000, 128)  # Replace with your actual [8000, 128] voxel data
    plot_voxelized_pointcloud_with_voxel_data(voxel, voxel_size=0.05, save_path="voxelized_plot.png", dpi=300)