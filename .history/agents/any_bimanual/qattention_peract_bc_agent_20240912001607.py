    ...
    def load_weights(self, savedir: str):
        ...
        for k, v in state_dict.items():
            ...
            # collision
                ...
                merged_state_dict[left_key] = v
            elif k.startwith("_qnet.module.lang_preprocess"):
                merged_state_dict[k] = v
                if self.use_skill:
                    right_key = k.replace("_qnet.module.lang_preprocess", "_qnet.module.lang_preprocess_right")
                    merged_state_dict[right_key] = v
                    
                    left_key = k.replace("_qnet.module.lang_preprocess", "_qnet.module.lang_preprocess_left")
                    merged_state_dict[left_key] = v
            elif k.startwith("_qnet.module.cross_attend_blocks"):
                if self.use_skill:
                    if k.startwith("_qnet.module.cross_attend_blocks.0"):
                        merged_state_dict[k] = v
                    ...
                    if k.startwith("_qnet.module.cross_attend_blocks.0"):
                        ...
                        merged_state_dict[k] = v
                        k_1 = k.replace("_qnet.module.cross_attend_blocks.1","_qnet.module.cross_attend_blocks.1")
                        k_2 = k.replace("_qnet.module.cross_attend_blocks.1","_qnet.module.cross_attend_blocks.3")
                        merged_state_dict[k_2] = v
                        merged_state_dict[k_3] = v
            # proprio
