...
class QAttentionPerActBCAgent(Agent):
    ...
    def update(self, step: int, replay_sample: dict) -> dict:
        ...
        gt = right_action_gripper_pose[0]
        gt = gt[,:3]
        print(gt.shape)
        ...
        if step % 1 == 0 and rank == 0:
            ...
            print((self._right_vis_gt_coordinate).shape)
            print(self._right_vis_gt_coordinate)
            print(right_action_trans[0].shape)
            print(right_action_trans[0])
            print(right_proprio)
