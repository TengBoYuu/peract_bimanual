    ...
    def forward(
        ...
        if self.training:
            ...
            if self.use_predictor:
                ...
                right_selected_options = self.option_selector(rgb[:4], lang_token_embs)
                left_selected_options = self.option_selector(rgb[-4:], lang_token_embs)
                # print(selected_options.shape)
                right_lang_token_embs = torch.cat((right_selected_options, lang_token_embs),dim=1)
                right_lang_token_embs = torch.cat((left_selected_options, lang_token_embs),dim=1)
