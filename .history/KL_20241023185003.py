...
# 读取 .npy 文件中的数据
voxel_left = read_voxel_data_from_npy("/mnt/disk_1/tengbo/peract_bimanual/voxel_left.npy")
voxel_right = read_voxel_data_from_npy("/mnt/disk_1/tengbo/peract_bimanual/voxel_right.npy")
