...
class BimanualAgent(Agent):
    ...
    def act(self, step: int, observation: dict,train_cfg: dict, deterministic: bool) -> ActResult:
        ...
        right_act_result = self.right_agent.act(step, right_observation,train_cfg, deterministic)
        left_act_result = self.left_agent.act(step, left_observation,train_cfg, deterministic)
