...
class LeaderFollowerAgent(Agent):
    ...
    def act(self, step: int, observation: dict, train_cfg: dict, deterministic: bool) -> ActResult:
        ...
        right_act_result = self.leader_agent.act(step, leader_observation,train_cfg, deterministic)
        ...
        left_act_result = self.follower_agent.act(step, follower_observation,train_cfg, deterministic)
