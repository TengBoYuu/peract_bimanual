...
class OfflineTrainRunner(BaseTrainTester):
    ...
    def __init__(self,
        ...
        self.variations = cfg.rlbench.variations
    ...
    def get_datasets(instructions,tasks,variations):
        """Initialize datasets."""
    ...
    def start(self):
        ...
        if self.method.startswith("DIFFUSER_ACTOR"):
            ...
            dataset = self.get_datasets(self.instructions,self.tasks,self.variations)
            data_iter = self.get_loaders(dataset,collate_fn=default_collate)
        else:
