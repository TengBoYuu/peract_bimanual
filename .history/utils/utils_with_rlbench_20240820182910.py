...
ALL_RLBENCH_TASKS = [
    ...
    'water_plants', 'wipe_desk', 'bimanual_pick_laptop'
]
...
class RLBenchEnv:
    ...
    def create_obs_config(
        ...
        for n in camera_names:
            kwargs[n] = used_cams
        camera_configs = {
            "front_camera": CameraConfig(kwargs.get("front", unused_cams)),
            "over_shoulder_left_camera":CameraConfig(kwargs.get("over_shoulder_left", unused_cams)),
            "over_shoulder_right_camera":CameraConfig(kwargs.get("over_shoulder_right", unused_cams)),
            "wrist_left_camera":CameraConfig(kwargs.get("wrist_left", unused_cams)),
            "wrist_right_camera":CameraConfig(kwargs.get("wrist_right", unused_cams)),
            "overhead_camera":CameraConfig(kwargs.get("overhead", unused_cams)),
        }
