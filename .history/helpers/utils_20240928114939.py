...
def create_voxel_scene(
    ...
    for x in range(0, 100):  # x > 50
        for y in range(0, 50):  # y > 50
            for z in range(0, 60):  # z > 50
                rgb[x, y, z] = [1.0, 1.0, 1.0, 0.2]  # Set transparency to 0.2
                # print(rgb[x, y, z, -1])
...
def visualise_voxel(
    ...
    if show:
        ...
        save_path = f"/mnt/disk_1/tengbo/peract_bimanual/voxel_vis/voxel_vis0_50/{filename}.png"
