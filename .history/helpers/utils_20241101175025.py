...
def create_voxel_scene(
    ...
    if highlight_coordinate is not None:
        ...
        try:
            ...
            rgb[x-size:x+size+1, y-size:y+size+1, z-size:z+size+1] = [0.0, 0.0, 1.0, highlight_alpha]   # blue
        except:
