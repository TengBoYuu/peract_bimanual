...
def create_voxel_scene(
    ...
    for x in range(51, d):  # x > 50
        for y in range(51, h):  # y > 50
            for z in range(51, w):  # z > 50
                rgb[x, y, z, -1] = [1.0, 1.0, 1.0, 1.0]  # Set transparency to 0.2
                print(rgb[x, y, z, -1])
...
def visualise_voxel(
    ...
    if show:
        ...
        image.save("/mnt/disk_1/tengbo/peract_bimanual/rendered_voxel_image.png")
        print("-----------------")
        return color.copy()
