...
def get_attn_indices_from_demo(
    ...
    frames.insert(0, 0)
    if Arm == 'right':
        right_cameras = ("over_shoulder_left", "over_shoulder_right", "overhead", "wrist_right", "wrist_left", "front")
        return [{cam: obs_to_attn_right(demo[f], cam) for cam in cameras} for f in frames]
    else:
        ("over_shoulder_left", "over_shoulder_right", "overhead", "wrist_right", "wrist_left", "front")
