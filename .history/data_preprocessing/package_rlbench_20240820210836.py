...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index: int) -> None:
        ...
        state_dict[2].extend(right_keyframe_action_ls[1:])
        state_dict[2].extend(left_keyframe_action_ls[1:])
        state_dict[3].extend(attn_indices)
        state_dict[4].extend(right_keyframe_action_ls[:-1])  # right gripper pos
        state_dict[4].extend(left_keyframe_action_ls[:-1])  # right gripper pos
