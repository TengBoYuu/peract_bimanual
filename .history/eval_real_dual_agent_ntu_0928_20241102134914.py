...
def main():
    ...
    for episode_idx in episode_list:
        ...
        episode_path = f'/mnt/disk_1/tengbo/bimanual_data/keypoint/{task_name}/all_variations/episodes/episode0'
        ...
        for keypoint_idx in range(test_num):
            ...
            print(f"prev_step_idx: {prev_step_idx:04d}, next_step_idx: {next_step_idx:04d}, step: {step}")

            image_path = os.path.join(episode_path, 'front_rgb', f'depth_{prev_step_idx:04d}.png')
