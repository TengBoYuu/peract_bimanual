...
# data1 = [8.00, 16.00, 4.00]
# data2 = [8.00, 22.00, 24.00]
# 计算平均值和标准误差
...
# ax.set_title('Real-World', fontsize=12)

# 在柱子上方标注平均值，移动到error bar之上
# for bar,  err in zip(bars, std_errors):
#     height = bar.get_height()
#     ax.annotate(  # 位置在error bar上方
#                 xytext=(0, 3),  # 位置偏移
...
# 保存图像为PNG格式
plt.savefig('rlbench.png', format='png')
