...
# 读取两个 .npy 文件中的数据
voxel_left = read_voxel_data_from_npy("/mnt/disk_1/tengbo/peract_bimanual/L_voxel_result.txt")
voxel_right = read_voxel_data_from_npy("/mnt/disk_1/tengbo/peract_bimanual/L_voxel_result1.txt")
