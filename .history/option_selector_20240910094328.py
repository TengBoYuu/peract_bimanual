...
class OptionSelector:
    def __init__(self, num_classer=18):
        """
    ...
    def compute_similarity(self, emb1, emb2):
        ...
        """
        # 计算每个 token 的余弦相似度
        token_similarities = F.cosine_similarity(emb1, emb2, dim=-1)
        
        # 对所有 token 的相似度取平均值
        average_similarity = token_similarities.mean()
        return average_similarity  # 在最后一维上计算余弦相似度
