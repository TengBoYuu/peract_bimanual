...
# cur_dir=$(pwd)
train_demo_path="/mnt/disk_1/tengbo/bimanual_data/train_real/"
keypoint_path="/mnt/disk_1/tengbo/bimanual_data/keypoint/"
...
logdir="/mnt/disk_1/tengbo/peract_bimanual-real/log"
instructions="/mnt/disk_1/tengbo/peract_bimanual-real/18_lang_template.pkl"
...
log_freq=100
# task_folder="multi"
replay_path="/mnt/disk_2/tengbo/replay_real_debug/"
training_iterations=200001
wandb_project="debug"
...
CUDA_VISIBLE_DEVICES=${train_gpu} python train.py method=$method \
        ...
        rlbench.keypoint_path=${keypoint_path} \
