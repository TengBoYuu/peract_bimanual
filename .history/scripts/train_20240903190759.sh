...
instructions="/mnt/disk_1/tengbo/peract_bimanual/instructions.pkl"
...
# wandb_project="debug"
# task_folder="debug"
# replay_path="/mnt/disk_1/tengbo/replay/debug/"
#########
...
CUDA_VISIBLE_DEVICES=${train_gpu} python train.py method=$method \
        ...
        cfg.framework.skill_predictor=${skill_predictor} \
