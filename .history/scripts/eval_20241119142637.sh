...
test_demo_path="/mnt/disk_1/tengbo/bimanual_data/train"
...
sleep 2s
tmux kill-session -t ${exp_name}_${eval_type}_${eval_episodes}
sleep 3s
echo "start new tmux session: ${exp_name}_${eval_type}_${eval_episodes}, running eval.py"
tmux new-session -d -s ${exp_name}_${eval_type}_${eval_episodes}
...
"
tmux -2 attach-session -t ${exp_name}_${eval_type}_${eval_episodes}