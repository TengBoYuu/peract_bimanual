...
SPLIT=train
DEMO_ROOT=/mnt/disk_1/tengbo/3d_diffuser_actor/data/peract/raw/${SPLIT}
RAW_SAVE_PATH=/mnt/disk_1/tengbo/3d_diffuser_actor/data/peract/raw_hires/${SPLIT}
PACKAGE_SAVE_PATH=/mnt/disk_1/tengbo/3d_diffuser_actor/data/peract/packaged_hires/${SPLIT}
...
xvfb-run -a python data_preprocessing/rearrange_rlbench_demos.py --root_dir /mnt/disk_1/tengbo/3d_diffuser_actor/data/peract/raw_hires/${SPLIT}
